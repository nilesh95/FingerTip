...
public class LoginActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TAG = getString(R.string.googleActivity);
        // Views
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // User is signed in
                    showProgressDialog();
                    Log.d(TAG, getString(R.string.onAuthStateChanged) + user.getUid());
                    ...
                    // User is signed out
                    Log.d(TAG, getString(R.string.onAuth_signed_out));
                    updateUI(user);
                }
            }
        };
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        Log.d(TAG, getString(R.string.firebaseauthGoogle) + acct.getId());
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Log.d(TAG, getString(R.string.sign_in_credential) + String.valueOf(task.isSuccessful()));
...
//                findViewById(R.id.sign_out_and_disconnect).setVisibility(View.VISIBLE);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        Toast.makeText(this, getString(R.string.errorPlayService), Toast.LENGTH_SHORT).show();
    }
